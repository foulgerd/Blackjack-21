...
public class testUser {
    ...
    public void testScoreEachCardValue(){
        ...
        assertEquals(10, p.calculateScore(p.hand)); // Check score of the card
        ...
        assertEquals(10, p.calculateScore(p.hand));
        cards.remove(0);
        p.hand.remove(0);
        ...
        for(int i = 9; i > 1; i--){
            ...
            // Checking value;
            assertEquals(i, p.calculateScore(p.hand));
        ...
        assertEquals(11, p.calculateScore(p.hand));
        cards.remove(0);
        p.hand.remove(0);

        // Check score for a bad card
        p.takeCard(badCard);
        assertEquals(0, p.calculateScore(p.hand));
    ...
    public void testTwoAces(){
        ...
        // Assert
        assertEquals(12, p.calculateScore(p.hand));
